package rabunabi.freechat.com.firebase;
...
public class NotificationService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        if (remoteMessage.getNotification() != null) { // from firebase console
            ...
            rabunabi.freechat.com.firebase.NotifyHelper.sendNotification(BalloonchatApplication.Companion.getContext(), "", "", remoteMessage.getNotification().getBody()
